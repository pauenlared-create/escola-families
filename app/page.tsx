...
const translations = {
  ca: {
    ...
    familyari: {
      ...
      p3: "FamilyAri aprèn del context de cada família i evoluciona a mesura que coneix millor cada infant, adolescent o família, per ajudar-vos a comprendre com funciona el seu cervell, perquè cada realitat és única.",
...
pDoc6: "D'aquesta preocupació, però també de la convicció que les famílies no han d'afrontar aquests reptes soles, neix Escola de Famílies.",
  ...
  es: {
    ...
    familyari: {
      ...
      p3: "FamilyAri aprende del contexto de cada familia y evoluciona a medida que conoce mejor a cada niño, adolescente o familia, para ayudaros a entender cómo funciona su cerebro, porque cada realidad es única.",
